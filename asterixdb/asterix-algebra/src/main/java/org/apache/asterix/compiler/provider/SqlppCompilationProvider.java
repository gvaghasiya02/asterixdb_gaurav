...
public class SqlppCompilationProvider implements ILangCompilationProvider {
    ...
    public Set<String> getCompilerOptions() {
        return new HashSet<>(Set.of(CompilerProperties.COMPILER_JOINMEMORY_KEY,
                ...
                CompilerProperties.COMPILER_CBO_GROUPMEMORY_KEY, CompilerProperties.COMPILER_CBO_SORTMEMORY_KEY,
                CompilerProperties.COMPILER_CBO_WINDOWMEMORY_KEY, CompilerProperties.COMPILER_CBO_TEXTSEARCHMEMORY_KEY,
                CompilerProperties.COMPILER_CBO_JOINMEMORY_KEY, CompilerProperties.COMPILER_PARALLELISM_KEY,
