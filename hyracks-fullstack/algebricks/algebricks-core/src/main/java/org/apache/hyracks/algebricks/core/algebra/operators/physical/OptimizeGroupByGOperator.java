...
public class OptimizeGroupByGOperator extends AbstractPreclusteredGroupByPOperator {

    private final boolean groupAll;

    public OptimizeGroupByGOperator(List<LogicalVariable> columnList, boolean groupAll) {
        super(columnList);
    ...
    public PhysicalOperatorTag getOperatorTag() {
        return PhysicalOperatorTag.OPTIMIZE_GROUP_BY_G;
    }
