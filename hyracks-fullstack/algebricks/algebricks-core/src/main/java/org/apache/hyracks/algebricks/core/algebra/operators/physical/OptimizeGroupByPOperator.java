...
public class OptimizeGroupByPOperator extends AbstractGroupByPOperator{
    private final OrderColumn[] orderColumns;

    public OptimizeGroupByPOperator(List<LogicalVariable> columnList, OrderColumn[] orderColumns) {
        super(columnList);
