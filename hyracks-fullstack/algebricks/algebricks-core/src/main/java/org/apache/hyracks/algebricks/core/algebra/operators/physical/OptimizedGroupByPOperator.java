...
public class OptimizedGroupByPOperator extends AbstractGroupByPOperator {
    private final OrderColumn[] orderColumns;

    public OptimizedGroupByPOperator(List<LogicalVariable> columnList, OrderColumn[] orderColumns) {
        super(columnList);
