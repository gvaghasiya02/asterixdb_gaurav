 ...
 * @author yingyib
 */
public class OptimizeGroupByRunMerger extends AbstractExternalSortRunMerger {
    ...
    public OptimizeGroupByRunMerger(IHyracksTaskContext ctx, List<GeneratedRunFileReader> runs, int[] sortFields,
