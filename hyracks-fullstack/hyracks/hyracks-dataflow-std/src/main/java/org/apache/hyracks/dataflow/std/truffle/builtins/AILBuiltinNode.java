 ...
 * The builtin functions are registered in {@link AILContext#installBuiltins}. Every builtin node
 * subclass is instantiated there, wrapped into a function, and added to the
 * {@link AILFunctionRegistry}. This ensures that builtin functions can be called like user-defined
...
@GenerateNodeFactory
public abstract class AILBuiltinNode extends AILExpressionNode {
