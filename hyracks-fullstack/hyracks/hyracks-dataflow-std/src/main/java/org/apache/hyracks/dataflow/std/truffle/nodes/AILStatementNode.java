 ...
 * local variables.
 */
@NodeInfo(language = "AIL", description = "The abstract base node for all SL statements")
@GenerateWrapper
public abstract class AILStatementNode extends AILScopedNode implements InstrumentableNode {
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new AILStatementNodeWrapper(this, probe);
    }
