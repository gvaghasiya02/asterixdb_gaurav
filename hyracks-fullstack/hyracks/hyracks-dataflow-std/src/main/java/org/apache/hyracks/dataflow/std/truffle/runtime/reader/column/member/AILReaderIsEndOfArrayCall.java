...
public final class AILReaderIsEndOfArrayCall implements TruffleObject {
    final AbstractTypedColumnReader reader;

    public AILReaderIsEndOfArrayCall(AbstractTypedColumnReader reader) {
        this.reader = reader;
    }
