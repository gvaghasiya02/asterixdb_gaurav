...
package org.apache.hyracks.dataflow.std.wailhashmap;
...
public enum Types implements TypesIEnumSerializer {
    ...
    public static final byte SERIALIZED_EMPTY_OBJECT_TYPE_TAG = EMPTY_OBJECT.serialize();
    public static final byte SERIALIZED_EMPTY_ARRAY_TYPE_TAG = EMPTY_ARRAY.serialize();
    public static final byte SERIALIZED_EMPTY_MULTISET_TYPE_TAG = EMPTY_MULTISET.serialize();

    /*
     * Serialized Tags end
     */
    public static final int TYPE_COUNT = Types.values().length;
    public static final Types[] VALUE_TYPE_MAPPING;
    private byte value;
    ...
    static {
        ...
        VALUE_TYPE_MAPPING = typeList.toArray(new Types[typeList.size()]);
    }
    ...
    public boolean isDerivedType() {
        return this == Types.OBJECT || this == Types.ARRAY || this == Types.MULTISET || this == Types.UNION;
    }

    // TODO(ali): remove and use ATypeHierarchy getTypeDomain()
    public final boolean isListType() {
        return this == Types.ARRAY || this == Types.MULTISET;
    }
